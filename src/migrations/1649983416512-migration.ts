...
export class migration1649983416512 implements MigrationInterface {
    name = 'migration1649983416512'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "item_on_list" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "price" integer NOT NULL, "quantity" integer NOT NULL, "productId" integer)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_item_on_list" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "price" integer NOT NULL, "quantity" integer NOT NULL, "productId" integer, CONSTRAINT "FK_7224c4e986eb2c48509bfa77e31" FOREIGN KEY ("productId") REFERENCES "product" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
