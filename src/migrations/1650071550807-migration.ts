...
export class migration1650071550807 implements MigrationInterface {
    name = 'migration1650071550807'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "temporary_list" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" datetime NOT NULL, "status" varchar NOT NULL, "itemOnListId" integer, CONSTRAINT "FK_819b79f710cdbd7240293f6e673" FOREIGN KEY ("itemOnListId") REFERENCES "item_on_list" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
